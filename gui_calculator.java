...
class gui_calculator extends JFrame implements ActionListener,Runnable {
JTextField t1;
JTextArea ta;
JLabel l;
...
Color bg=new Color(200,220,250);
...
//to remove grey colored highlight when a button is pressed
b.setFocusPainted(false);
b.setBorderPainted(false);
b.setOpaque(true);

if("0123456789.Cdel%=".contains(b.getText())){
...
jp1.setLayout(new GridLayout(6,4,5,5));
jp1.add(b17);jp1.add(b21);jp1.add(b18);jp1.add(b4);
jp1.add(b1);jp1.add(b2);jp1.add(b3);jp1.add(b8);
jp1.add(b5);jp1.add(b6);jp1.add(b7);jp1.add(b12);
jp1.add(b9);jp1.add(b10);jp1.add(b11);
jp1.add(b16);jp1.add(b13);jp1.add(b14);jp1.add(b15);jp1.add(b19);jp1.add(b20);
...
JOptionPane.showMessageDialog(gui_calculator.this,e.getMessage());
}
}
//main function
